...
# --- 1. 基础配置 ---
st.set_page_config(page_title="MyQuant Pro - 基准对比版", layout="wide")
...
if raw_df is not None:
    ...
    with tab2:
        ...
        # 超额收益 (Alpha)
        alpha = ret - bench_ret
        m3.metric("超额收益 (Alpha)", f"{alpha*100:.2f}%", help="策略收益 - 基准收益。如果是正的，说明你战胜了市场。")
        ...
        if st.button("🚀 开始优化"):
            ...
            for sl in sl_range:
                for tp in tp_range:
                    ...
                    # 注意：优化时也返回 bench_ret，但我们只需要 ret
